...
run:
	sudo docker run -d --restart="always" -p 9292:80 -v $(HOME)/workspace:/app --link apache-stanza.redirect:rdf.glytoucan.org --link apache-stanza.redirect:test.ts.glytoucan.org --name="stanza_bluetree" aoki/stanza 
